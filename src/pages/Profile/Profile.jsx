...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <AIAssistant pageContext="Profile page (customer) – user can view and edit personal information (email is read-only, full name, phone, and default delivery address are editable via pencil icons), see member since date and completed orders, and use the Security tab to send a password reset link." />
    </div>
  );
}